# ============================================================
# vehicle_demand.py
# - Forecast HOURLY DEMAND per vehicle_type
# - Model: Baseline Naive + Prophet (kalau tersedia)
# - Output per-vehicle di folder output_vehicle_demand/
# ============================================================
...
def run_vehicle_forecast():
    ...
    for vt in vehicle_types:
        ...
        if HAS_PROPHET:
            ...
            print("  ⚠ Prophet tidak tersedia, skip Prophet untuk semua vehicle_type.")
